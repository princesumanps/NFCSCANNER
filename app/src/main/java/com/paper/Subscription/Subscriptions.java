...
import com.paper.carhub.DONECODE;
import com.paper.carhub.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.basic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().replace(R.id.fragementcontainer, new BasicPlan()).addToBackStack(null).commit();
            }
        });
        binding.advance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().replace(R.id.fragementcontainer, new AdvancePlan()).addToBackStack(null).commit();
            }
        });
        binding.premium.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().replace(R.id.fragementcontainer, new PremiumPlan()).addToBackStack(null).commit();
            }
        });
                ...
                try {
                    firebaseDatabase.getReference().child("OTP").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (binding.otp.getText().toString().equals(s)){
